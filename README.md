...
маскировки `get_mask_card_number` и `get_mask_account`
* Стандартный ввод;
* Нестандартный ввод;
* Граничный ввод;
...
обработки виджетов `mask_account_card` и `get_date`
...
фильтрации и сортировки `filter_by_state` и `sort_by_date`
...
Тесты проверяют:
* Правильность фильтрации по валюте, возврат пустого списка, если данных нет.
* Возврат верных описаний операций, корректность работы с пустым списком.
* Генерацию номеров карт в нужном формате и диапазоне, граничные случаи.
