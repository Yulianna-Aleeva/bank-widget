...
`test_log_success_to_console`, `test_log_success_to_file`, `test_log_error_to_console` и `test_log_error_to_file`

Тесты логирования:
* Успешное выполнение функции (логируется сообщение "... ok");
